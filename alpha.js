        ...
        try {
            ...
            for (let num of participants) {
                try {
                    ...
                    ppuser = 'https://j.top4top.io/p_2888qfcxy3.jpg'
                    ppuser2 = 'https://k.top4top.io/p_2888h9bw90.jpg'
                }
                ...
                if (anu.action == 'add' && isWelcome) {
                  ...
                  if (isSetLeft(anu.id, set_left_db)) {            	
                      ...
                      alpha.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `${full_pesan}` })
                       	...
                       	alpha.sendMessage(anu.id, { image: { url: ppuser2 }, mentions: [num], caption: `,@${num.split("@")[0]}` })
                        }
