...
case 'saldo':{
  ...
  var cpt = `╭───✵「  *Saldo ${pushname}* 」✵
┃  Status : User
┃  Saldo  : ${formatRupiah(saldouser)}
╰───✵

╭───✵
┃ ➳  Deposit saldo? silahkan ketik pay
╰───✵
...
┃ ➳ Order ketik : .co qris|${product.productId} 1
...
╭───✵「  CARA ORDER  」✵
┃ 💭 Pembayaran tersedia : *Qris, Saldo*
┃ 💭 Ketik ini untuk membeli dengan :
┃ saldo 
┃ ➥ *${prefix}co saldo|IDProduk jumlah*
┃ Qris 
┃ ➥ *${prefix}co saldo|IDProduk jumlah*
╰───✵
